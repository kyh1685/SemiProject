(function()
{
	return function()
	{
		nexacro._setCSSMaps(
		{
					...
					},
					{
						"btn_default" :
						{
							"self" :
							{
								"enabled" :
								{
									"color" : nexacro.ColorObject("#5e5e5e"),
			...
			"CheckBox" :
			{
				"self" :
				{
					"enabled" :
					{
						...
						"color" : nexacro.ColorObject("#757575")
					},
					"mouseover" :
					{
			...
			"Edit" :
			{
				"self" :
				{
					"enabled" :
					{
						"border" : nexacro.BorderObject("1px solid #d5d5d5"),
						"padding" : nexacro.PaddingObject("1px 9px 0px 9px"),
						"font" : nexacro.FontObject("12px \"Magun Gothic\""),
						"color" : nexacro.ColorObject("#6d6d6d")
					},
					"mouseover" :
					{
						"border" : nexacro.BorderObject("1px solid #5a86cd")
					...
					"nulltext" :
					{
						"color" : nexacro.ColorObject("#78afb9"),
						"font" : nexacro.FontObject("12px \"Malgun Gothic\"")
					}
				}
			},
			...
			"Static" :
			{
				"self" :
				{
					...
					{
						"color" : nexacro.ColorObject("#999999"),
						"font" : nexacro.FontObject("bold 12px \"Magun Gothic\"")
					},
					"disabled" :
					{
						"color" : nexacro.ColorObject("#999999"),
					...
					},
					{
						"sta_title" :
						{
							"self" :
							{
								"enabled" :
								{
									"font" : nexacro.FontObject("bold 20pt \"Malgun Gothic\""),
				...
				"parent" :
				{
					"Tab" :
					{
						"self" :
						{
							"enabled" :
							{
								"border" : nexacro.BorderObject("1px none #e0e0e0, 1px solid #e0e0e0, 1px solid #e0e0e0, 0px none")
							}
						}
					}
				}
				...
				"parent" :
				{
					"Tab" :
					{
						"self" :
						{
							"enabled" :
							{
								"color" : nexacro.ColorObject("#606060"),
								"border" : nexacro.BorderObject("1px none #c7c7c7, 1px none #c7c7c7, 1px solid #c7c7c7"),
							...
							"selected" :
							{
								...
								"border" : nexacro.BorderObject("1px none #c7c7c7")
							},
							"focused_selected" :
							{
								"color" : nexacro.ColorObject("#c4c4c4"),
		...
		imgcache[nexacro._getImageLocation("theme://images/back_log.png")] = { width:400, height:300 };
