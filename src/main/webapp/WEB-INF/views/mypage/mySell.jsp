...
<script src="http://code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script>
                    <style>
						...
						.endHide,.userHide{display: none;margin: 10px;background-color: rgba(255, 255, 255, 0.49);border-radius: 5px;}
						.myHide{margin: 10px;background-color: rgba(255, 255, 255, 0.49);border-radius: 5px;}
                        ...
                        .databox{height:50px;}
                        .seq,.product,.price,.Date{height:50px;float:left;text-align:center;line-height:50px;}
                        .seqT,.productT,.priceT,.DateT{height:50px;float:left;text-align:center;line-height:50px;}
                        .seq,.seqT{width:8%}.price,.priceT{width:12%}.product,.productT{width:65%;}.Date,.DateT{width:15%}
     ...
     <jsp:include page="/WEB-INF/views/aside.jsp"></jsp:include>
                                ...
                                <div class=dataSet>
                                    <div class="data">
                                        <div class=titlebox>
                                            ...
                                            <div class=productT>제목</div>
                                            <div class=priceT>가격</div>
                                            <div class=DateT>작성 일자</div>
                                        </div>
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="i" items="${list}">
                                                    <div class=databox>	
                                                        ...
                                                        <div class=price>${i.goodPrice}</div>
                                                        <div class=Date>
                                                            <fmt:parseDate var="Date" value="${i.goodDate}" pattern="yyyy-MM-dd"/>
                ...
                <script>
                    ...
                    $("#search").on("click", function(){
                        ...
                        var end = $("#endDate").val();
                        if(start <= end){
                            location.href="/mypage/searchMySell.mp?page=1&startDate="+start+"&endDate="+end;
                        }else{
                            alert("날짜를 다시 선택해주세요");
                        }
                    })
