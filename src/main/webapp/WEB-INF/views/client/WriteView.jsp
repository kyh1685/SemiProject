...
<div class="topNav">
    ...
    <nav>
     ...
     <section>
     	...
     	<form action="/client/okupdatewrite.center?seq=${dto.seq}" method=post>
			<table>
            	<tr>
            		<td>작성자</td>
            		<td>
            	...
            	<tr>
            		<td>내용</td>
            		<td><textarea class="tarea" name="contents">${dto.contents }</textarea></td>
            	</tr>
            	<tr>
            		<td>답변</td>
            		<td><textarea class="answer">${dto.answer }</textarea></td>
            	</tr>
            	<tr>
            		<td colspan="2">
    ...
    document.getElementById("cancel").onclick=function(){
        location.href="/client/clientCenter.center?cpage=1";
    }
    $("#delete").on("click",function(){
    	if(confirm("삭제하시겠습니까?")){
    		location.href="/client/delete.center?seq=${dto.seq}";
    	}
    })
    </script>
</body>
