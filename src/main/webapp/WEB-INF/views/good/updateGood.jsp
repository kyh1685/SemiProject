    ...
    <html>
        <head>
            ...
            <style>
                ...
                *{box-sizing: border-box; font-family: 'GmarketSansMedium';}
                ...
                .inputArea2_2 {width: 90%; height: 100%; padding:5px 110px;}
                ...
                .updBtn {width:200px; height: 30px; border-style: none; border-radius: 10px; background-color: #99D8E1;}
            </style>
        </head>
        <body>
            <!--HEADER-->
			...
			<c:choose>
                ...
                <div class="hederTitle">
                    <div class="titles">
                        ...
                        <div class="mainTitle"><a href="/">재능판매 장터</a></div>
                    </div>
                </div>
                <div class=inputArea>
            ...
            <div class="container">
                <form action="/good/update.good" method="post" enctype="multipart/form-data">
                    <div class="inputArea1">
                        <b>내가 작성한글 수정하기</b>
                        <input type='hidden' name='goodSeq' value="${dto.goodSeq}"/>
                    </div>
                    <div class="inputArea2">
                        ...
                        <input type=hidden name='cateCode' value=${dto.cateCode}>
                            <c:if test="${dto.cateCode==1}"> 삽니다</c:if>
                            <c:if test="${dto.cateCode==2}"> 팝니다  </c:if>
                        </div>
                    ...
                    <div class="inputArea3">
                        ...
                        <div class="inputArea3_2">
                            <input type="text" id="goodName" name="goodName" value="${dto.goodName}"required />
                        </div>
                    </div>
                    ...
                    <div class="inputArea4">
                        ...
                        <div class="inputArea4_2">
                            <input type="text" id="goodPrice" name="goodPrice" value="${dto.goodPrice}"required/>
                        </div>
                    </div>
                    ...
                    <div class="inputArea6">
                        ...
                        <textarea id="goodDes" name="goodDes" required>${dto.goodDes}</textarea>
                    ...
                    <div class="inputArea7">
                        ...
                        <button type="submit" id="updateBtn" class="updBtn">수정하기</button>
                        <button type="button" id="backBtn" class="updBtn">취소</button>
        ...
        CKEDITOR.replace("goodDes",{
            ...
            document.getElementById("backBtn").onclick = function() {
                location.href = "/good/view.good?goodSeq=${dto.goodSeq}&page=1";
            }
        </script>
        <script>
            $("#goodImg").change(
